...
class Seller_Form extends React.Component {
  ...
  onFinish=(values)=>{
    ...
    const postData = {
      ...
      "type": "placement_seller",
      "type2": "",
      "type3": "",
      "type4": "",
      "title": "کاریابی فروشنده",
...
export default connect(mapStateToProps , mapDispatchToProps)(Seller_Form);
