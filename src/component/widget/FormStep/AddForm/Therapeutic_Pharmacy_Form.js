...
class Therapeutic_Pharmacy_Form extends React.Component {
  ...
  onFinish=(values)=>{
    ...
    const postData = {
      ...
      "type": "treatment_estates_pharmacy",
      "type2": "",
      "type3": "",
      "type4": "",
      "title": "املاک درمانی داروخانه",
...
export default connect(mapStateToProps , mapDispatchToProps)(Therapeutic_Pharmacy_Form);
