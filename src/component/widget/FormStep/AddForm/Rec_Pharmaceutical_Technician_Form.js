...
class Rec_Pharmaceutical_Technician_Form extends React.Component {
  ...
  onFinish=(values)=>{
    ...
    const postData = {
      ...
      "type": "employment_technician",
      "type2": "",
      "type3": "",
      "type4": "",
      "title": "استخدام تکنسین دارویی",
...
export default connect(mapStateToProps , mapDispatchToProps)(Rec_Pharmaceutical_Technician_Form);
