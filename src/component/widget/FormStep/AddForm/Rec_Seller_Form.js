...
class Rec_Seller_Form extends React.Component {
  ...
  onFinish=(values)=>{
    ...
    const postData = {
      ...
      "type": "employment_seller",
      "type2": "",
      "type3": "",
      "type4": "",
      "title": "استخدام فروشنده",
    ...
    <div className="group-button">
        ...
        <Form {...formItemLayout} ref={this.formRef} name="form" onFinish={this.onFinish} >
          ...
          <Form.Item
              ...
              >
                  <Option value="medicinal">شرکت دارویی</Option>
                  <Option value="cosmetic">آرایشی بهداشتی </Option>
                  <Option value="scientific">نماینده علمی</Option>
...
export default connect(mapStateToProps , mapDispatchToProps)(Rec_Seller_Form);
