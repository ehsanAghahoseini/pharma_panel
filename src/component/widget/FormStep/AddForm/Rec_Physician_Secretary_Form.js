...
class Rec_Physician_Secretary_Form extends React.Component {
    ...
    <div className="group-button">
        ...
        <Form {...formItemLayout} ref={this.formRef} name="form" onFinish={this.onFinish} >
          ...
          <Form.Item
              ...
              label="مدت سابقه"
              rules={[{required: true, message: 'مدت سابقه را وارد کنید', whitespace: true}]}
          >
              <Input/>
          </Form.Item>
          ...
          <Form.Item
              ...
              <Select
                  showSearch
                  placeholder="تقاضای عادی/دندانپزشکی/پوست و ..."
                  optionFilterProp="children"
                  filterOption={(input, option) =>
                      option.children.toLowerCase().indexOf(input.toLowerCase()) >= 0
                  }
              >
                  ...
                  <Option value="skin">پوست و مو</Option>
                  <Option value="ophthalmology">چشم پزشکی</Option>
...
export default connect(mapStateToProps , mapDispatchToProps)(Rec_Physician_Secretary_Form);
