...
class Rec_Internship_Form extends React.Component {
  ...
  onFinish=(values)=>{
    ...
    const postData = {
      ...
      "type": "employment_intern",
      "type2": "",
      "type3": "",
      "type4": "",
      "title": "استخدام کارآموز",
    ...
    <div className="group-button">
        ...
        <Form {...formItemLayout} ref={this.formRef} name="form" onFinish={this.onFinish} >
          ...
          <Form.Item
              ...
              rules={[{required: true,},]}>
              <Select
                  placeholder="مدرک دارم/ندارم"
                  optionFilterProp="children"
                  filterOption={(input, option) =>
                      option.children.toLowerCase().indexOf(input.toLowerCase()) >= 0
                  }
              >
                  <Option value="true">نیاز است</Option>
                  <Option value="false">نیاز نیست</Option>
              </Select>
          </Form.Item>
...
export default connect(mapStateToProps , mapDispatchToProps)(Rec_Internship_Form);
