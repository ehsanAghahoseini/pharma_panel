...
class Internship_Form extends React.Component {
  ...
  onFinish=(values)=>{
    ...
    const postData = {
      ...
      "type": "placement_intern",
      "type2": "",
      "type3": "",
      "type4": "",
      "title": "کاریابی کارآموز",
...
export default connect(mapStateToProps , mapDispatchToProps)(Internship_Form);
