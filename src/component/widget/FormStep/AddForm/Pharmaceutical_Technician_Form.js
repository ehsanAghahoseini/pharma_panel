...
class Pharmaceutical_Technician_Form extends React.Component {
  ...
  onFinish=(values)=>{
    ...
    const postData = {
      ...
      "type": "placement_technician",
      "type2": "",
      "type3": "",
      "type4": "",
      "title": "کاریابی تکنسین دارویی",
...
export default connect(mapStateToProps , mapDispatchToProps)(Pharmaceutical_Technician_Form);
