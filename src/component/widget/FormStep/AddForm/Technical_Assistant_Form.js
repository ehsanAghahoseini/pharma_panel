...
class Technical_Assistant_Form extends React.Component {
  ...
  onFinish=(values)=>{
    ...
    const postData = {
      ...
      "type": "placement_responsible",
      "type2": "",
      "type3": "",
      "type4": "",
      "title": "کاریابی مسئول فنی",
...
export default connect(mapStateToProps , mapDispatchToProps)(Technical_Assistant_Form);
