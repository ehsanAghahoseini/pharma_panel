...
class Rec_Technical_Assistant_Form extends React.Component {
  ...
  const {Option} = Select;  
    ...
    <div className="group-button">
        ...
        {/* <Button danger onClick={()=>{this.props.StepState('recruitment')}}>بازگشت</Button> */}
        <Form {...formItemLayout} ref={this.formRef} name="form" onFinish={this.onFinish} >
          ...
          <Form.Item
              name="demand"
              label="انتخاب موسس/مسئول فنی"
              rules={[{required: true}]}
              >
              <Select
                  placeholder=" موسس / مسئول فنی"
                  optionFilterProp="children"
              >
                  <Option value="founder">موسس</Option>
                  <Option value="responsible">مسئول فنی</Option>
          ...
          <Form.Item
              name="license"
              label="پروانه دائم/موقت"
              rules={[{required: true}]}
              >
              <Select
                  placeholder="پروانه دائم/موقت"
                  optionFilterProp="children"
              >
                  <Option value="permanent">دائم</Option>
                  <Option value="temporary">موقت</Option>
                  <Option value="student">دانشجو سال آخر</Option>
              </Select>
          </Form.Item>

          <Form.Item
              name="shift"
              label="انتخاب نوع شیفت"
              rules={[{required: true}]}
              >
              <Select
                  placeholder="انتخاب نوع شیفت"
                  optionFilterProp="children"
              >
...
export default connect(mapStateToProps , mapDispatchToProps)(Rec_Technical_Assistant_Form);
