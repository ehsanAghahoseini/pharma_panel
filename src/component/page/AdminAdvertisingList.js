...
class AdminAdvertisingList extends React.Component {
  ...
  // this function change switch ads
   onChangeSwitch(id ) {
    ...
    $.ajax({
      url: BASE_URL + '/acception_new_personal_ad.php',
      type: 'post',
      dataType: 'json',
      data: JSON.stringify({
  ...
  // Function For Time
  //  TimeAddADS() {
  //   const time = Date.now() - P_D_T.time;
  ...
  deleteitem = () => {
    ...
    $.ajax({
      url: BASE_URL + '/delete_unique_ad.php',
      type: 'post',
      dataType: 'json',
      data: JSON.stringify({
        "username":localStorage.getItem('username'),
  ...
  componentDidMount() {
    this.setState({display:true});
    $.ajax({
      url: BASE_URL + '/get_unique_ads.php',
      type: 'post',
      dataType: 'json',
      data: JSON.stringify({
        "username":localStorage.getItem('username'),
...
export default AdminAdvertisingList;
